...
class SegMultiLabelDBDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if cached is not None:
            ...
            # print('beatmap_info')
            # print(beatmap_info)
            self.cache_operation(audio_file_path, audio_data, op='put')
        ...
        # therefore we perform preprocessing individually for each beatmap,
        # while caching audio data after I/O but before preprocessing

        preprocessed_audio_data = SegMultiLabelDBDataset.preprocess(audio_data,
                                                                    *(self.beatmap_info_list[audio_idx]),
