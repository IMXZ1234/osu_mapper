...
class CNNv1Dataset(Dataset):
    ...
    """
    def __init__(self, index_file_path, beatmap_obj_file_path=None, feature_frames_per_beat=512):
    ...
    def get_start_time_microseconds(self, beatmap):
    ...
    def get_end_time_microseconds(self, beatmap):
    ...
    def hit_objects_to_label(self, beatmap, audio_start_time_offset, snap_per_microsecond, total_snap_num):
    ...
    def __getitem__(self, index):
        ...
        valid_time_interval = [self.get_start_time_microseconds(beatmap), self.get_end_time_microseconds(beatmap)]
        ...
        # print(valid_interval)
        label = self.hit_objects_to_label(beatmap, audio_start_time_offset, snap_per_microsecond, total_snap_num)
        # print('len(label)')
        # print(len(label))
        try:
