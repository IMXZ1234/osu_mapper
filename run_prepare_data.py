...
from preprocess.dataset import mlp_dataset, rnn_dataset, rnn_nolabel_dataset, mlp_nolabel_dataset, rnnv2_dataset, \
    rnnv3_dataset, rnnv3_nolabel_dataset, rnnv4_dataset, label_pos_dataset, label_pos_datasetv2, label_pos_datasetv3
...
def prepare_label_pos_dataset():
    ds = label_pos_dataset.LabelPosDataset(
...
def prepare_label_pos_datasetv3():
    ds = label_pos_datasetv3.LabelPosDataset(
