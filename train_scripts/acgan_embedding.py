...
def train_acgan_embeddingv10(setting_name='acgan_embeddingv10'):
    """
    acganv1_embedding
    """
    random_seed = 404
    ...
    for gen_lr, dis_lr in [[7e-5, 7e-5]]:
        print('init lr %s' % str(gen_lr))
        config_path = './resources/config/train/%s.yaml' % setting_name
        model_arg = {
            'model_type': ['nn.net.acgan_embeddingv10.Generator', 'nn.net.acgan_embeddingv10.Discriminator'],
            'params': [
                {
                    'n_snap': subseq_snaps,
                    'tgt_embedding_dim': 16,
        ...
        train_arg = {'epoch': 20480,
                     ...
                     'noise_sched_arg': {
                         'y_coeff': 0.5,
                         # noise drop to 0.36 at batch 5000
                         'x_coeff': 0.00007,
                         'low_bound': 0.,
                         'period': None,
                         'batch_step_ref': True,
...
def train_acgan_embeddingv11(setting_name='acgan_embeddingv11'):
    """
    acganv1_embedding
    """
    random_seed = 404
    ...
    for gen_lr, dis_lr in [[7e-5, 7e-5]]:
        ...
        config_path = './resources/config/train/%s.yaml' % setting_name
        model_arg = {
            'model_type': ['nn.net.acgan_embeddingv11.Generator', 'nn.net.acgan_embeddingv11.Discriminator'],
            'params': [
                {
                    'n_snap': subseq_snaps,
                    'tgt_embedding_dim': 16,
...
def train_acgan_embeddingv12(setting_name='acgan_embeddingv12'):
    """
    acganv1_embedding
    """
    random_seed = 404
    ...
    for gen_lr, dis_lr in [[3e-5, 3e-5]]:
        print('init lr %s' % str(gen_lr))
        config_path = './resources/config/train/%s.yaml' % setting_name
        model_arg = {
            'model_type': ['nn.net.acgan_embeddingv12.Generator', 'nn.net.acgan_embeddingv12.Discriminator'],
            'params': [
                {
                    'n_snap': subseq_snaps,
                    'tgt_embedding_dim': 16,
