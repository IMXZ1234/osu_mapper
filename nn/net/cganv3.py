...
class FeatureExtractor(nn.Module):
    ...
    def __init__(self, in_channels, out_channels):
        ...
        self.model = nn.Sequential(
            *conv_block(in_channels, out_channels, kernel_size=1, normalize=False, act=False),
...
class Generator(nn.Module):
    def __init__(self, output_len, in_channels, num_classes, noise_in_channels,
        ...
        self.model = nn.Sequential(
            *conv_block(noise_in_channels + self.ext_out_channels, self.num_classes * 16, kernel_size=7, normalize=False),
...
class Discriminator(nn.Module):
    def __init__(self, output_len, in_channels, num_classes,
        ...
        self.model = nn.Sequential(
            *conv_block(self.num_classes + self.ext_out_channels, self.num_classes * 8, kernel_size=7, normalize=False),
