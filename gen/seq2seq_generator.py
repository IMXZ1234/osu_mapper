...
class Seq2SeqGenerator(BeatmapGenerator):
    def __init__(self,
                 inference_config_path='./resources/config/inference/seq2seq.yaml',
    ...
    def generate_beatmapset(self, audio_file_path, speed_stars_list, meta_list,
        ...
        beatmap_label_list = self.inference.run_inference_seq2seq()
