...
from gen.label_interpreter import LabelWithPosInterpreter
from util import beatmap_util


class SeqGANv3Generator(BeatmapGenerator):
    def __init__(self,
                 inference_config_path='./resources/config/inference/seqganv3.yaml',
    ...
    def generate_beatmapset(self, audio_file_path, speed_stars_list, meta_list,
        ...
        beatmap_label_list = self.inference.run_inference_seqganv3()
        ...
        for beatmap_label, beatmap, out_path in \
            ...
            LabelWithPosInterpreter.gen_hitobjects(
