...
def train_acgan_embeddingv1(setting_name='acgan_embeddingv1'):
    ...
    # 32 beat per subseq
    beat_divisor = 8
    subseq_snaps = 32 * beat_divisor
    mel_features = 40

    for gen_lr, dis_lr in [[0.000003, 0.000003]]:
        print('init lr %s' % str(gen_lr))
        config_path = './resources/config/train/%s.yaml' % setting_name
        model_arg = {
        ...
        data_arg = {'dataset': 'nn.dataset.feeder_embedding.SubseqFeeder',
                    'train_dataset_arg':
                        {'save_dir': r'/home/data1/xiezheng/osu_mapper/preprocessed_v4',
        ...
        train_arg = {'epoch': 4,
                     ...
                     # 'noise_level_step': [30, 60, 90, 120],
                     # 'noise_level': [0.5, 0.5, 0.5, 0.5, 0.5],
                     'noise_level_step': [1, 2, 3],
                     'noise_level': [1.0, 0.5, 0.1, 0],
                     # 'noise_level': [0.5, 0.3, 0.1, 0.05, 0.],
                     'lambda_gp': 10,
                     'lambda_cls': 5.,
                     # 'last_epoch': 12,
...
if __name__ == '__main__':
    ...
    train_acgan_embeddingv1('acgan_embeddingv1_20231006_g0.000003_d0.000003_test')
